...
urlpatterns = [
    ...
    path('admin/predictresults/<id>/', predict_results, name='predict-results'),
    path('admin/startdailymatchprediction/', start_daily_match_prediction, name='start-daily-match-prediction'),
